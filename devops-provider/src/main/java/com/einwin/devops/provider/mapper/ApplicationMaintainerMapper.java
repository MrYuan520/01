 ...
 */
@Mapper
public interface ApplicationMaintainerMapper extends GenericMapper<ApplicationMaintainer, Long> {
    int disabledByAppId(Long appId);
    int deleteByAppId(Long appId);
    List<ApplicationMaintainer> getByAppId(Long appId);
}